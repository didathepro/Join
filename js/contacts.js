        ...
        <div class="contact-img">
            ...
            <div class="name-container">
                ...
                <div class="edit-delete">
                    <div class="edit"><svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <section class="logInContainer">
                <form id="addContactForm">
                    ...
                    <div class="buttons-container">
                        <button class="cancel" onclick="closeAddContactContainer();">Cancel <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button type="button" class="create" onclick="addContactToArray();closeAddContactContainer();">Create contact<img src="../assets/img/Vector (2).png"></button>
                    </div>
                </form>
            </section>
        </div>
...
function closeAddContactContainer() {
